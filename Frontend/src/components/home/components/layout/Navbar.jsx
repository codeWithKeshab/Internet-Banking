...
const navItems = ["Home",  "AdminLogin"];
const navIcons = [
  ...
  <Link to="/admins/login">
   <IoLogIn size={25} className="mr-1" />
   </Link>
];
      ...
      >
        <nav className="max-w-[1800px] w-full mx-auto px-4 sm:px-10 md:px-12 py-2 md:py-4 flex justify-between items-center z-20">
          ...
          <div className="hidden lg:flex justify-center items-center gap-4 px-4 text-lg text-slate-800">
            ...
            <Link to="/">
              <div   className="flex justify-center items-center   p-3 !font-sans font-bold rounded-lg hover:text-white hover:bg-slate-800">
               Home
                
          <AiFillHome size={25} className="mr-1" />
